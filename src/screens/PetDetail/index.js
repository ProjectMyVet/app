...
export function PetDetailScreen({ navigation, route }) {
  ...
  function handleRedirectTratments() {
    navigation.navigate('Treatments', { pet, userId })
  }

  function handleRedirectMedications() {
    navigation.navigate('Medications', { pet, userId })
  }
      ...
      {({handleChange, handleBlur, handleSubmit, values}) => (
        <View>
          ...
          <View style={styles.buttonCard}>
            ...
            <View style={styles.button}>
              <MVButton onPress={handleRedirectTratments}>
                Tratamentos
              </MVButton>
            </View>
            <View style={styles.button}>
              <MVButton onPress={handleRedirectMedications}>
                Medicamentos
              </MVButton>
            </View>
          </View>
